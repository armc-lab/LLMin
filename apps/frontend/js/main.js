...
或直接上传合同以获得基于合同原文的精确解读。`;
    ...
    hasActiveConversation() {
        ...
        // 需要有当前会话标识（历史会话或当前上传会话均可）
        const hasConversationId = Boolean(this.state.currentConversationId);
        ...
        console.log('检查对话状态:', {
            ...
            hasConversationId: hasConversationId,
            hasMessages: hasMessages
        });

        return isInChatMode && hasConversationId && hasMessages;
    }
