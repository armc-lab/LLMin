...
为了帮你更准确地判断投保资格，能否告诉我你的年龄和目前的血压范围呢？`;
        ...
        // 年龄相关回复
        if (message.includes('我现在有高血压，可以投这个保险吗?') || /\d+岁/.test(message)) {
            return `根据保险合同【第 4.2 条关于重大疾病的定义】，轻度高血压并不在拒保范围内，可以投保。另外，根据《中国高血压防治指南》:
·轻度高血压:140/90mmHg-160/100mmHg。
·中度高血压:160/100mmHg-180/110mmHg
·重度高血压:180/110mmHg 以上
为了帮您更准确地判断报保资格，能否告诉我您的年龄和目前的血压范围呢?
`;
        }
